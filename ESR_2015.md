...
- [4.  Primary and Secondary Production](#4-primary-and-secondary-production)
  - [4. 1. Primary Production](#4-1-primary-production)
    ...
    - [4.1.4. Phytoplankton Groups](#414-phytoplankton-groups)
...
- [10.  Stressors and Impacts](#10-stressors-and-impacts)
  ...
  - [10. 2. Climate Change](#10-2-climate-change)
    ...
    - [Center of Biomass of Finfish](#center-of-biomass-of-finfish)
...
![Figure 4.1. Annual trends in small and large phytoplankton on the Northeast US shelf.](figures/ex4-1.png "Figure 4.1. Annual trends in small and large phytoplankton on the Northeast US shelf.") 
...
Figure 4.2. Total amount of zooplankton (measured as displacement volume) for the Gulf of Maine (GOM), Georges Bank (GB) and the Mid-Atlantic Bight (MAB) in NEFSC plankton surveys.
...
![Figure 5.2. Estimated forage fish species biomass on the Northeast Shelf.](figures/ex5-2.png "Figure 5.2. Estimated forage fish species biomass on the Northeast Shelf.") 
...
## Condition Factor
![Figure 5.6. Change in condition presented as normalized time series from high (dark blue) to low (light blue) condition.](figures/ex5-6.png "Figure 5.6. Change in condition presented as normalized time series from high (dark blue) to low (light blue) condition.") 
...
![Figure 6.2. Trends in fishery revenues by gear type on the Northeast Shelf.](figures/ex6-2.png "Figure 6.2. Trends in fishery revenues by gear type on the Northeast Shelf.") 
...
![Figure 1.2 Time series of mean annual sea surface temperature of the Northeast Shelf with the output of the STARS regime shift detection algorithm (red line).](figures/s1_2.png "Figure 1.2 Time series of mean annual sea surface temperature of the Northeast Shelf with the output of the STARS regime shift detection algorithm (red line).") 
...
Figure 2.2 The Gulf Stream Path anomaly from 1955 to 2014 (based on annual means). Positive (negative) phases correspond to more northern (more southern) positions of the Gulf Stream Path.
...
![Figure 2.3 The Multivariate ENSO index (MEI) from 1950 to 2012 (based on annual means).  Positive (negative) phases correspond to warm El Nino (cool La Nina) phases of the MEI (Wolter and Timlin 2011).](figures/Climate_MEI.png "Figure 2.3 The Multivariate ENSO index (MEI) from 1950 to 2012 (based on annual means).  Positive (negative) phases correspond to warm El Nino (cool La Nina) phases of the MEI (Wolter and Timlin 2011).") 
...
Figure 2.4 NOAA GFDL's ESM2M projection of SST for the US NES LME under the IPCC high emission scenario [representative concentration pathway (RCP) 8.5].  The projection is based on SST anomalies calculated by subtracting the mean value from the historical period (1981 to 2005).  The plot is a smoothed, 10-year running average.
...
Figure 2.5 NOAA GFDL's ESM2M projection of ocean surface pH for the U.S. NES LME under the IPCC high emission scenario [representative concentration pathway (RCP) 8.5].  The projection is based on pH anomalies calculated by subtracting the mean value from the historical period (1981 to 2005).  The plot is a smoothed, 10-year running average.
...
Figure 3.5:  Annual averages of monthly mean wind stress near Cape Hatteras (blue), New York (green) and Georges Bank (red).  The magnitude (top panel), east-west component (middle panel) and north-south component (bottom panel) of wind stress are shown.
...
## 3.5. Temperature
![Figure 3.6:  Long-term summer and winter sea surface temperatures averaged over the northeast U.S. continental shelf and adjacent waters from the ERSSTv3b dataset.](figures/pp6.png "Figure 3.6:  Long-term summer and winter sea surface temperatures averaged over the northeast U.S. continental shelf and adjacent waters from the ERSSTv3b dataset.") 
...
![Figure 4.3 The first spatial mode of chlorophyll derived from an Empirical Orthogonal Function (EOF).](figures/primary_chlorophyll_eof.png "Figure 4.3 The first spatial mode of chlorophyll derived from an Empirical Orthogonal Function (EOF).") 

Figure 4.3 The first spatial mode of chlorophyll derived from an Empirical Orthogonal Function (EOF).

![Figure 4.4 Phytoplankton color index anomalies for the Gulf of Maine and Mid-Atlantic Bight continuous plankton recorder transects.](figures/primary_cpr_index.png "Figure 4.4 Phytoplankton color index anomalies for the Gulf of Maine and Mid-Atlantic Bight continuous plankton recorder transects.") 
...
Figure 4.6 Interpolated chlorophyll time series for each ecological production unit.  Note the data are displayed on a log<sub>10</sub> scale
...
Figure 4.7 Seasonal total, microplankton (> 20 &micro;m) and nano+picoplankton (< 20 &micro;m) chlorophyll concentrations.  Winter - December, January and February; Spring - March, April and May; Summer - June, July and August; Fall - September, October and November
...
### Copepods
![Figure 4.11 Time series of total copepod abundance.  Annual averages are presented.](figures/primary_total_copepods.png "Figure 4.11 Time series of total copepod abundance.  Annual averages are presented.") 
...
Figure 4.14  Siphonophore and salp abundance anomaly (per 100 m3) as a function of year for Georges Bank, Gulf of Maine, Scotian Shelf (A), and the Middle Atlantic Bight (B).  Note different scales between A and B.
...
![Figure 5.1 Biomass indices for (a) American lobster from NEFSC autumn bottomtrawl surveys on the Scotian Shelf, Gulf of Maine and Georges Bank, (b) Northern shrimp from R/V Gloria Michelle summer surveys, (c) crab species based on NEFSC bottom trawl surveys, and (d) Cancer crabs and selected echinoderm genera based on NEFSC scallop surveys.](figures/Benthic_biomass.png "Figure 5.1 Biomass indices for (a) American lobster from NEFSC autumn bottomtrawl surveys on the Scotian Shelf, Gulf of Maine and Georges Bank, (b) Northern shrimp from R/V Gloria Michelle summer surveys, (c) crab species based on NEFSC bottom trawl surveys, and (d) Cancer crabs and selected echinoderm genera based on NEFSC scallop surveys.") 

Figure 5.1 Biomass indices for (a) American lobster from NEFSC autumn bottomtrawl surveys on the Scotian Shelf, Gulf of Maine and Georges Bank, (b) Northern shrimp from R/V Gloria Michelle summer surveys, (c) crab species based on NEFSC bottom trawl surveys, and (d) Cancer crabs and selected echinoderm genera based on NEFSC scallop surveys.

![Figure 5.2 Biomass trends of sea scallops, ocean quahogs and Atlantic surfclamsfrom stock assessment model output (see [NEFSC 2014; NEFSC 2009; NEFSC 2013] respectively).](figures/Benthic_scallop_clam.png "Figure 5.2 Biomass trends of sea scallops, ocean quahogs and Atlantic surfclamsfrom stock assessment model output (see [NEFSC 2014; NEFSC 2009; NEFSC 2013] respectively).") 

Figure 5.2 Biomass trends of sea scallops, ocean quahogs and Atlantic surfclamsfrom stock assessment model output (see [NEFSC 2014; NEFSC 2009; NEFSC 2013] respectively).
...
Figure 5.3 Index of relative abundance for macrobenthos species groups (3 yr blocks).  Indices are based on using fish predators as samplers, representing how often one of these organism groups occurs in stomachs of fish sampled in this ecosystem.
...
![Figure 6.1 Survey indices (mean catch per tow) of aggregate species groups caught during NEFSC autumn bottom trawl surveys.](figures/fish_relative_biomass_guilds_fall.png "Figure 6.1 Survey indices (mean catch per tow) of aggregate species groups caught during NEFSC autumn bottom trawl surveys.") 

Figure 6.1 Survey indices (mean catch per tow) of aggregate species groups caught during NEFSC autumn bottom trawl surveys.

![Figure 6.2 Total fish biomass estimates from NEFSC autumn bottom trawl surveys disaggregated by each ecological production unit.](figures/fish_total_biomass_fish_fall.png "Figure 6.2 Total fish biomass estimates from NEFSC autumn bottom trawl surveys disaggregated by each ecological production unit.") 
...
## 6.2. Biodiversity
![Figure 6.4 The mean expected number of species from the NEFSC autumn bottom trawl survey by ecological production units.  Tows were standardized using 100 individuals.](figures/fish_biodiversity.png "Figure 6.4 The mean expected number of species from the NEFSC autumn bottom trawl survey by ecological production units.  Tows were standardized using 100 individuals.") 
...
## 6.3. Average Size
![Figure 6.5 Average length (cm) of all finfish species caught in NEFSC autumn bottom trawl surveys disaggregated by each ecological production unit.](figures/fish_average_length_fall.png "Figure 6.5 Average length (cm) of all finfish species caught in NEFSC autumn bottom trawl surveys disaggregated by each ecological production unit.") 

Figure 6.5 Average length (cm) of all finfish species caught in NEFSC autumn bottom trawl surveys disaggregated by each ecological production unit.
...
![Figure 6.6 Mean trophic level of all finfish species caught in NEFSC autumn bottom trawl surveys disaggregated by each ecological production unit.](figures/fish_trophic_level_fall.png "Figure 6.6 Mean trophic level of all finfish species caught in NEFSC autumn bottom trawl surveys disaggregated by each ecological production unit.") 
...
Figure 6.7 Change in condition presented as normalized time series from high (dark blue) to low (light blue) condition, and sorted by species/stock group using principal components.
...
![Figure 6.8 Change in recruits per spawner presented as normalized time series for 20 groundfish stocks 1985-2007 from NEFSC stock assessment reports.](figures/fc8.png "Figure 6.8 Change in recruits per spawner presented as normalized time series for 20 groundfish stocks 1985-2007 from NEFSC stock assessment reports.") 
...
## 7.1. Marine Mammals
![Figure 7.1 Best estimate of total North Atlantic right whale population size from NEFSC right whale surveys (Waring et al. 2013).](figures/ps1.png "Figure 7.1 Best estimate of total North Atlantic right whale population size from NEFSC right whale surveys (Waring et al. 2013).") 
...
## 7.2. Sea Turtles
![Figure 7.2 Location of loggerhead, leatherback, green, and Kemp's ridley turtle groups based on a summer 2010 aerial survey (NEFSC 2011).](figures/ps2.png "Figure 7.2 Location of loggerhead, leatherback, green, and Kemp's ridley turtle groups based on a summer 2010 aerial survey (NEFSC 2011).") 
...
## 7.3. Seabirds
![Figure 7.3 Annual mean SST for May, June, July, August based on three NDBC buoys in the Gulf of Maine (1984-2012).](figures/ps3.png "Figure 7.3 Annual mean SST for May, June, July, August based on three NDBC buoys in the Gulf of Maine (1984-2012).") 

Figure 7.3 Annual mean SST for May, June, July, August based on three NDBC buoys in the Gulf of Maine (1984-2012).

![Figure 7.4 Arctic tern fledging success on Matinicus Rock, Maine from 1984 to 2012.](figures/ps4.png "Figure 7.4 Arctic tern fledging success on Matinicus Rock, Maine from 1984 to 2012.") 

Figure 7.4 Arctic tern fledging success on Matinicus Rock, Maine from 1984 to 2012.

![Figure 7.5 Atlantic puffin and Arctic tern fledgling success in three Maine colonies from 2002 to 2012.](figures/ps5.png "Figure 7.5 Atlantic puffin and Arctic tern fledgling success in three Maine colonies from 2002 to 2012.") 

Figure 7.5 Atlantic puffin and Arctic tern fledgling success in three Maine colonies from 2002 to 2012.

![Figure 7.6 Fish proportions in Atlantic puffin diet on Seal Island, Maine between 2006 and 2012.](figures/ps6.png "Figure 7.6 Fish proportions in Atlantic puffin diet on Seal Island, Maine between 2006 and 2012.") 

Figure 7.6 Fish proportions in Atlantic puffin diet on Seal Island, Maine between 2006 and 2012.

![Figure 7.7 Fish proportions in Arctic tern diet on Seal Island, Maine between 1991 and 2012.](figures/ps7.png "Figure 7.7 Fish proportions in Arctic tern diet on Seal Island, Maine between 1991 and 2012.") 

Figure 7.7 Fish proportions in Arctic tern diet on Seal Island, Maine between 1991 and 2012.

![Figure 7.8 Amphipod and Euphausiid proportions in Arctic tern diet on Seal Island, Maine.](figures/ps8.png "Figure 7.8 Amphipod and Euphausiid proportions in Arctic tern diet on Seal Island, Maine.") 
...
![Figure 8.1 Northeast Region coastal population and per capita income, 1969-2012 (Income measured in 2012 dollars).](figures/hd1.png "Figure 8.1 Northeast Region coastal population and per capita income, 1969-2012 (Income measured in 2012 dollars).") 
...
![Figure 8.2 Gross revenue from federally-permitted commercial vessels (2014 dollars), by gear types.](figures/hd2.png "Figure 8.2 Gross revenue from federally-permitted commercial vessels (2014 dollars), by gear types.") 

Figure 8.2 Gross revenue from federally-permitted commercial vessels (2014 dollars), by gear types.
...
![Table 8.1 The indices and the variables within each index, as of 2013 (Source: Jepson and Colburn 2013: Tables 1, 2, and 3).](figures/hdt1.png "Table 8.1 The indices and the variables within each index, as of 2013 (Source: Jepson and Colburn 2013: Tables 1, 2, and 3).") 
...
![Figure 8.4 Social vulnerability ranking for the Northeastern U.S.](figures/hd4.png "Figure 8.4 Social vulnerability ranking for the Northeastern U.S.") 

Figure 8.4 Social vulnerability ranking for the Northeastern U.S.

![Figure 8.5 Gentrification vulnerability ranking for the Northeastern U.S.](figures/hd5.png "Figure 8.5 Gentrification vulnerability ranking for the Northeastern U.S.") 

Figure 8.5 Gentrification vulnerability ranking for the Northeastern U.S.

![Figure 8.6 Recreational fisheries engagement ranking for the Northeast U.S.](figures/hd6.png "Figure 8.6 Recreational fisheries engagement ranking for the Northeast U.S.") 

Figure 8.6 Recreational fisheries engagement ranking for the Northeast U.S.

![Figure 8.7 Recreational fisheries reliance ranking for the Northeast U.S.](figures/hd7.png "Figure 8.7 Recreational fisheries reliance ranking for the Northeast U.S.") 

Figure 8.7 Recreational fisheries reliance ranking for the Northeast U.S.

![Figure 8.8 Commercial fisheries engagement ranking for the Northeast U.S.](figures/hd8.png "Figure 8.8 Commercial fisheries engagement ranking for the Northeast U.S.") 

Figure 8.8 Commercial fisheries engagement ranking for the Northeast U.S.

![Figure 8.9 Commercial fisheries reliance ranking for the Northeast U.S.](figures/hd9.png "Figure 8.9 Commercial fisheries reliance ranking for the Northeast U.S.") 

Figure 8.9 Commercial fisheries reliance ranking for the Northeast U.S.

## 8.4. Communities-at-Sea
![Figure 8.10 Fishing patterns of area-dependent and mobile fishermen.](figures/hd10.png "Figure 8.10 Fishing patterns of area-dependent and mobile fishermen.") 
...
![Figure 8.11 Historical cod and haddock spawning areas in relation to Maine territorial waters (Source: Ames 1998:56).](figures/hd11.png "Figure 8.11 Historical cod and haddock spawning areas in relation to Maine territorial waters (Source: Ames 1998:56).") 
...
![Figure 9.2 Recreational fishing harvest and releases for the NES LME.](figures/es9-1-2.png "Figure 9.2 Recreational fishing harvest and releases for the NES LME.") 
...
Figure 9.3. Production of farmed Atlantic salmon and value in the state of Maine (Courtesy Maine Dept. of Marine Resources). Information not available after 2010 due to confidentiality constraints.

![Figure 9.4.  Production of oysters and hard and soft clams and associated value for the most recent information available for each state.](figures/es9-1-4.png "Figure 9.4.  Production of oysters and hard and soft clams and associated value for the most recent information available for each state.") 
...
![Figure 9.5 Production and value of seaweed harvest in the State of Maine (Courtesy of Maine Department of Natural Resources).](figures/es9-1-5.png "Figure 9.5 Production and value of seaweed harvest in the State of Maine (Courtesy of Maine Department of Natural Resources).") 
...
![Figure 9.7. Ship traffic over the NESLME in 2011 for all vessels required to carry an AIS transponder.](figures/es9-1-7.png "Figure 9.7. Ship traffic over the NESLME in 2011 for all vessels required to carry an AIS transponder.") 
...
![Figure 9.13 Estimates of coastal wetland extent from Maine to New York for the period 1906-1978 (adapted from Gosselink and Baumann 1980).](figures/es9-2-1.png "Figure 9.13 Estimates of coastal wetland extent from Maine to New York for the period 1906-1978 (adapted from Gosselink and Baumann 1980).") 
...
![Figure 9.16 Annual mapped SAV area (ha) for the Chesapeake Bay, reproduced from Orth et al. 2013.](figures/es9-2-4.png "Figure 9.16 Annual mapped SAV area (ha) for the Chesapeake Bay, reproduced from Orth et al. 2013.") 

Figure 9.16 Annual mapped SAV area (ha) for the Chesapeake Bay, reproduced from Orth et al. 2013.
...
![Figure 9.23. Average bottom temperatures during the month of September from 1995-2008.  The Cold Pool is the band of 6-9&deg;C water surrounded on all sides by warmer temperatures. Locations marked on the map: CB: Chesapeake Bay, CM: Cape May, HC: Hudson Canyon, MP: Montauk Point and NS: Nantucket Shoals.](figures/fig9-23.png "Figure 9.23. Average bottom temperatures during the month of September from 1995-2008.  The Cold Pool is the band of 6-9&deg;C water surrounded on all sides by warmer temperatures. Locations marked on the map: CB: Chesapeake Bay, CM: Cape May, HC: Hudson Canyon, MP: Montauk Point and NS: Nantucket Shoals.") 
...
Figure 10.5 Total annual gallons of chemical and oil spills during 2000-2011 (Source U.S. Coast Guard Marine Casualty and Pollutant Database). Note that reporting and case resolution delays affect the most recent years.
...
![Figure 10.6 Location of  reported chemical and oil spills from vessels (Source U.S. Coast Guard Marine Casualty and Pollutant Database).](figures/sc6.png "Figure 10.6 Location of  reported chemical and oil spills from vessels (Source U.S. Coast Guard Marine Casualty and Pollutant Database).") 

Figure 10.6 Location of  reported chemical and oil spills from vessels (Source U.S. Coast Guard Marine Casualty and Pollutant Database).

![Figure 10.7 Location of  reported chemical and oil spills from facilities (Source U.S. Coast Guard Marine Casualty and Pollutant Database).](figures/sc7.png "Figure 10.7 Location of  reported chemical and oil spills from facilities (Source U.S. Coast Guard Marine Casualty and Pollutant Database).") 

Figure 10.7 Location of  reported chemical and oil spills from facilities (Source U.S. Coast Guard Marine Casualty and Pollutant Database).

![Figure 10.8 Location of  reported chemical and oil spills from other sources (Source U.S. Coast Guard Marine Casualty and Pollutant Database).](figures/sc8.png "Figure 10.8 Location of  reported chemical and oil spills from other sources (Source U.S. Coast Guard Marine Casualty and Pollutant Database).") 
...
### 10.1.5. Algal Blooms
![Figure 10.11 Alexandrium cyst counts in the Gulf of Maine (J. Kleindinst, WHOI, personal communication).](figures/sc11.png "Figure 10.11 Alexandrium cyst counts in the Gulf of Maine (J. Kleindinst, WHOI, personal communication).") 

Figure 10.11 Alexandrium cyst counts in the Gulf of Maine (J. Kleindinst, WHOI, personal communication).

![Figure 10.12 Red tide associated shellfish closures in the Gulf of Maine expressed as kilometer days of closure (product of length of shoreline closed and duration of closure (derived from Kleindinst et al. 2014).](figures/sc12.png "Figure 10.12 Red tide associated shellfish closures in the Gulf of Maine expressed as kilometer days of closure (product of length of shoreline closed and duration of closure (derived from Kleindinst et al. 2014).") 
...
![Figure 10.13 Standardized anomalies of Phaeocystis density in the Gulf of Maine based on Continuous Plankton Recorder observations.](figures/sc13.png "Figure 10.13 Standardized anomalies of Phaeocystis density in the Gulf of Maine based on Continuous Plankton Recorder observations.") 
...
### 10.1.6. Bacteria
![Figure 10.14 Beach closure metrics (total number of beaches affected, number of beach actions, and total number of days under a beach action for the Gulf of Maine (upper) and the Mid-Atlantic Bight.](figures/sc14.png "Figure 10.14 Beach closure metrics (total number of beaches affected, number of beach actions, and total number of days under a beach action for the Gulf of Maine (upper) and the Mid-Atlantic Bight.") 

Figure 10.14 Beach closure metrics (total number of beaches affected, number of beach actions, and total number of days under a beach action for the Gulf of Maine (upper) and the Mid-Atlantic Bight.
...
![Figure 10.16 Along-shelf position of the center of biomass for nine fish species over time from the NEFSC autumn bottom trawl survey.](figures/sc16.png "Figure 10.16 Along-shelf position of the center of biomass for nine fish species over time from the NEFSC autumn bottom trawl survey.") 
...
![Figure 10.17 Location of dams constructed for power generation, recreational purposes (fishing empoundments etc., and other uses.](figures/sc17.png "Figure 10.17 Location of dams constructed for power generation, recreational purposes (fishing empoundments etc., and other uses.") 
...
![Figure 10.18 Locations of existing hydroelectric dams in the Northeastern United States (data courtesy of the Nature Conservancy)](figures/sc18.png "Figure 10.18 Locations of existing hydroelectric dams in the Northeastern United States (data courtesy of the Nature Conservancy)") 

Figure 10.18 Locations of existing hydroelectric dams in the Northeastern United States (data courtesy of the Nature Conservancy)

![Figure 10.19 Locations of existing  dams built for recreational purposes (e.g fishing impoundments etc.) in the Northeastern United States (data courtesy of the Nature Conservancy).](figures/sc19.png "Figure 10.19 Locations of existing  dams built for recreational purposes (e.g fishing impoundments etc.) in the Northeastern United States (data courtesy of the Nature Conservancy).") 

Figure 10.19 Locations of existing  dams built for recreational purposes (e.g fishing impoundments etc.) in the Northeastern United States (data courtesy of the Nature Conservancy).
...
Figure 10.20 Locations of existing dams for other purposes (e.g. irrigation systems) in the Northeastern United States (data courtesy of the Nature Conservancy).
...
![Figure 10.27 Distribution of major substrate categories on the Northeast US Continental Shelf (courtesy of the New England Fishery Management Council Omnibus Habitat Plan Development Team).](figures/sc27.png "Figure 10.27 Distribution of major substrate categories on the Northeast US Continental Shelf (courtesy of the New England Fishery Management Council Omnibus Habitat Plan Development Team).") 
...
Figure 10.28 Distribution of natural disturbance categories (high, low) on the Northeast US Continental Shelf (courtesy of the New England Fishery Management Council Omnibus Habitat Plan Development Team).

![Figure 10.29 Relative risk arrayed by gear type and habitat category for geological features in high energy regimes.](figures/sc29.png "Figure 10.29 Relative risk arrayed by gear type and habitat category for geological features in high energy regimes.") 

Figure 10.29 Relative risk arrayed by gear type and habitat category for geological features in high energy regimes.

![Figure 10.30 Relative risk arrayed by gear type and habitat category for geological features in low energy regimes.](figures/sc30.png "Figure 10.30 Relative risk arrayed by gear type and habitat category for geological features in low energy regimes.") 

Figure 10.30 Relative risk arrayed by gear type and habitat category for geological features in low energy regimes.

![Figure 10.31 Relative risk arrayed by gear type and habitat category for biological features in high energy regimes.](figures/sc31-sm.png "Figure 10.31 Relative risk arrayed by gear type and habitat category for biological features in high energy regimes.") 

Figure 10.31 Relative risk arrayed by gear type and habitat category for biological features in high energy regimes.

![Figure 10.32 Relative risk arrayed by gear type and habitat category for biological features in low energy regimes.](figures/sc32.png "Figure 10.32 Relative risk arrayed by gear type and habitat category for biological features in low energy regimes.") 
...
![Figure 10.22 Distribution of fishing activity by otter trawls as reflected in the spatial distribution of landings.](figures/sc22.png "Figure 10.22 Distribution of fishing activity by otter trawls as reflected in the spatial distribution of landings.") 

Figure 10.22 Distribution of fishing activity by otter trawls as reflected in the spatial distribution of landings.

![Figure 10.23 Distribution of fishing activity by scallop and clam dredges as reflected in the spatial distribution of landings.](figures/sc23.png "Figure 10.23 Distribution of fishing activity by scallop and clam dredges as reflected in the spatial distribution of landings.") 

Figure 10.23 Distribution of fishing activity by scallop and clam dredges as reflected in the spatial distribution of landings.

![Figure 10.24 Distribution of fishing activity by pot gear as reflected in the spatial distribution of landings.](figures/sc24.png "Figure 10.24 Distribution of fishing activity by pot gear as reflected in the spatial distribution of landings.") 

Figure 10.24 Distribution of fishing activity by pot gear as reflected in the spatial distribution of landings.

![Figure 10.25 Distribution of fishing activity by Gillnets as reflected in the spatial distribution of landings.](figures/sc25.png "Figure 10.25 Distribution of fishing activity by Gillnets as reflected in the spatial distribution of landings.") 

Figure 10.25 Distribution of fishing activity by Gillnets as reflected in the spatial distribution of landings.

![Figure 10.26 Distribution of fishing activity by seines as reflected in the spatial distribution of landings.](figures/sc26.png "Figure 10.26 Distribution of fishing activity by seines as reflected in the spatial distribution of landings.") 
...
Figure 10.33 Number of incidents involving marine mammals through entanglement, entrapment, non-human interactions, unknown  and vessel strikes.  Total number of incidents by species (upper panel) and number of events by incident category (lower panel).

![Figure 10.34 Total number of sea turtle strandings in the Northeastern United States 1986-2013.](figures/sc34.png "Figure 10.34 Total number of sea turtle strandings in the Northeastern United States 1986-2013.") 
...
![Figure 10.37 Average depth of capture for a group of 48 species resident on the Northeast US Continental Shelf.](figures/fig10-37.png "Figure 10.37 Average depth of capture for a group of 48 species resident on the Northeast US Continental Shelf.") 
...
![Figure 11.3 Status of fish stocks managed by the Mid-Atlantic Fishery Management Council.  Stocks with biomass levels less than 0.5 B/Bmsy are classified as overfished.  Overfishing is occurring for stocks with a F/Fmsy ratio greater than 1.0.](figures/sd03.png "Figure 11.3 Status of fish stocks managed by the Mid-Atlantic Fishery Management Council.  Stocks with biomass levels less than 0.5 B/Bmsy are classified as overfished.  Overfishing is occurring for stocks with a F/Fmsy ratio greater than 1.0.") 

Figure 11.3 Status of fish stocks managed by the Mid-Atlantic Fishery Management Council.  Stocks with biomass levels less than 0.5 B/Bmsy are classified as overfished.  Overfishing is occurring for stocks with a F/Fmsy ratio greater than 1.0.
...
Figure 11.5 Recovery factor (Fr) for marine mammals on the Northeast U.S Continental Shelf. (Fr ranges from 0 to 1 with 1 indicating a complete recovery; the outer circle in the polar plot corresponds to a value of 1). Species within the inner most circle as classified as endangered.
...
Figure 11.6 Coastal Condition Reports for the  Northeast Coast of the U.S. for five major indicators of status: water quality, sediment quality, coastal habitat, benthos, and fish contaminant level.  Scores range from 1 (poor) to 5 (good)
